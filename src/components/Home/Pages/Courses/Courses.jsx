    ...
    return (
        <div className='container'>
            <div className=' pt-5 py-5'>
                <h4 className='text-center navbar-color rounded text-white p-3 h2'>
                    ...
                    <div className='col-xl-3 col-lg-3 col-md-6 col-sm-12 col-xs-12'>
                        <div className='single-courses'>
                            <div
                                ...
                                <div className='card-body'>
                                    <h5 className='card-title'>
                                        IOSH Managing Safely is delivered using
                                        animated presentation through LMS
                                    </h5>
                                    <hr className='navbar-color' />
                                    <p className='card-text'>
                            ...
                            <div
                                ...
                                <div className='card-body'>
                                    <h5 className='card-title'>
                                        ...
                                        systems auditor/lead auditor training
                                        from BESI Private Limited
                                    </h5>
                                    <hr className='navbar-color' />
                                    <p className='card-text'>
                            ...
                            <div
                                ...
                                <div className='card-body'>
                                    ...
                                    <p className='card-text'>
                                        ...
                                        (QMS) standard from BESI Private
                                        Limited,continuously improve their
                                        performance.
                                    </p>
                                    <hr className='navbar-color' />
                            ...
                            <div
                                ...
                                <div className='card-body'>
                                    ...
                                    <p className='card-text'>
                                        ...
                                        Health and Safety is developed to
                                        provide a thorough knowledge of health
                ...
                <div className='short-courses pt-5'>
                    <h4 className='text-center navbar-color p-3 rounded h2'>
                        ...
                        <div className='col-xl-3 col-lg-3 col-md-6 col-sm-12 col-xs-12'>
                            <div className='single-courses'>
                                <div
                                    ...
                                    <div className='card-body'>
                                        <p className='card-text'>
                                            Since the 1st of October, 2013 it
                                            has been employer’s responsibility
                                            to provide first aiders in the
                                            workplace. All organisations must
                                            ensure
                                        </p>
                                        <hr className='navbar-color' />
                                    </div>
                                ...
                                <div
                                    ...
                                    <div className='card-body'>
                                        <p className='card-text'>
                                            ...
                                            Safety qualifications to meet with
                                ...
                                <div
                                    ...
                                    <div className='card-body'>
                                        <p className='card-text'>
                                            ...
                                            as a result of fire in the
                                            workplace. Fire can cost businesses
                        ...
                        <div className='col-xl-3 col-lg-3 col-md-6 col-sm-12 col-xs-12'>
                            <div className='single-courses'>
                                <div
                                    ...
                                    <div className='card-body'>
                                        <p className='card-text'>
                                            Country regulations state that all
                                            food handlers must receive
                                            appropriate training in food safety
                        ...
                        <div className='col-xl-3 col-lg-3 col-md-6 col-sm-12 col-xs-12'>
                            <div className='single-courses'>
                                <div
                                    ...
                                    <div className='card-body'>
                                        <p className='card-text'>
                                            Construction Sector is essential and
                                            an integral part of infrastructure
                                            development which gives tremendous
                                ...
                                <div
                                    ...
                                    <div className='card-body'>
                                        <p className='card-text'>
                                            ...
                                            comply with basic legislation. This
                                            Risk Assessment Training is IOSH
                                            approved.
                                        </p>
                                        <hr className='navbar-color' />
                                    </div>
                                ...
                                <div
                                    ...
                                    <div className='card-body'>
                                        <p className='card-text'>
                                            ...
                                            maintenance activities on chemical
                                            plant and so prevent a major
                                            accident.
                                        </p>
                                        <hr className='navbar-color' />
                                    </div>
