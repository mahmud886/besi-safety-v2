                        ...
                        <div className='row'>
                            <div className='contact-us pt-3 py-2 bg-light shadow-sm rounded '>
                                <div className='text-center'>
                                    <h1>Contact Us:</h1>
                                    <p>
                                        We are a passionate Engineering and
                                        safety Institute that specializes in
                                        beautiful and easy-to-use Engineering
                                        and safety services.
                                    </p>
                                </div>
                                <div className='row'>
                                    ...
                                    <div className='col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12'>
                                        <div className='address-methods pt-5 py-5'>
                                            ...
                                            <p className='text-black-50'>
                                                ...
                                                147/H, Darul Huda Bhaban Green
                                                Road, Dhaka-1215(lift-5)
                                            </p>
                                            <p className='text-black-50'>
                                                {' '}
